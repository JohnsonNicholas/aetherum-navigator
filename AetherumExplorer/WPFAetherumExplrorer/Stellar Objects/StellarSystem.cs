...
namespace TwilightShards.AetherumExplorerW
{
    ...
    public class StellarSystem : INotifyPropertyChanged
    {
        ...
        private StellarEventLogger _systemHistory;
        ...
        /// </summary>
        public StellarEventLogger SystemHistory
        {
            get { return _systemHistory;  }
            set
            {
                if (value != this._systemHistory)
                {
                    _systemHistory = value;
                    this.NotifyPropertyChanged();
                }
            }
        }
        ...
        public StellarSystem()
        {
            ...
            this.SystemHistory.AddLogEvent("A nearby supernova causes the GSC to merge together",
                                          -10000,
                                          StellarEventType.SystemCreation);
        }
