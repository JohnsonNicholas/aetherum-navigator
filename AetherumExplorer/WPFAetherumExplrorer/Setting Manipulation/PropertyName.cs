...
namespace TwilightShards.AetherumExplorerW
{
    ...
    public enum PropertyName
    {
        ...
        [PropDefs(ValType.LongType,10000,10000000,50000, 0)]
        ...
        /// </summary>
        /// <remarks>The default value is NKS, but it can be up to 10 characters</remarks>
        [PropDefs(ValType.StringType,0,0,"NKS",10)]
        DefaultSystemPrefix,
        ...
        [PropDefs(ValType.LongType, 1000, 100000000, 100000, 0)]
